	...
	public static void main(String[] args) {
		...
		do {
			...
			if (sortType.equals("s")) {
				...
				// Note: Java's built-in sort is Tim sort (for objects) or something else (for
				// primitives). "Something else" could mean quick sort, or a different approach
				// depending on the "sortedness" of the array being sorted.
			...
			// print timing results (NOTE: first timing of a new sort appears slower than
			// usual because
